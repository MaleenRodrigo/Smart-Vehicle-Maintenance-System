...
const AddVehicle = () => {
  ...
  return (<>
    ...
    <form onSubmit={onSubmit} className="max-w-2xl mx-auto px-4 py-6">
      ...
      <div className="mb-4">
        <label htmlFor="dailyusage" className="block text-sm font-medium text-gray-700">Daily Usage:</label>
        <input
          type="text"
          id="dailyusage"
          name="dailyusage"
      ...
      <div className="mb-4">
        <label htmlFor="licenseissued" className="block text-sm font-medium text-gray-700">License Issued Date:</label>
        <input
          type="date"
          id="licenseissued"
          name="licenseissued"
      ...
      <div className="mb-4">
        <label htmlFor="expirydate" className="block text-sm font-medium text-gray-700">Insurance Expiry Date:</label>
        <input
          type="date"
          id="expirydate"
          name="expirydate"
      ...
      <div className="mb-4">
        <label htmlFor="issueddate" className="block text-sm font-medium text-gray-700">Insurance Issued Date:</label>
        <input
          type="date"
          id="issueddate"
          name="issueddate"
      ...
      <button type="submit" className="bg-indigo-500 text-white py-2 px-4 rounded-md hover:bg-indigo-600 block mx-auto mt-8">Add Vehicle</button>
