...
const Navbar = () => {
  return (
    <>
      <header>
        <nav className="fixed z-50 bg-gray-200 border-b border-gray-200 backdrop-filter backdrop-blur-xl bg-opacity-30  w-full px-4 lg:px-6 py-5 :bg-gray-800 rounded-b-3xl">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div className="flex items-center lg:order-2">
              <Link
                to="/signin"
                className="text-gray-800 cursor-pointer :text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 :hover:bg-gray-700 focus:outline-none :focus:ring-gray-800"
              >
                Log in
              </Link>
              <a
            ...
            >
              <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                <li>
                  <Link
                    to="/"
                    className="block py-2 pr-4 pl-3 text-primary rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 :text-white"
                    aria-current="page"
                  >
                    Home
                  </Link>
